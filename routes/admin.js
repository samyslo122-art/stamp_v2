...
router.post('/admin/login', (req, res) => {
  ...
  res.render('admin-login', { csrfToken: req.csrfToken, error: 'Invalid PIN. Please check .env settings.' });
});
...
router.get('/admin/booth', requireAdmin, (req, res) => {
  res.render('admin-booth', { csrfToken: req.csrfToken, booths: config.BOOTHS });
});
